...
DROP TABLE MovieCollections;
CREATE TABLE `MovieCollections` (
  `Collection_ID` int NOT NULL,
  `Movie_ID` int NOT NULL,
  PRIMARY KEY (`Movie_ID`,`Collection_ID`),
  KEY `Collection_ID` (`Collection_ID`),
  CONSTRAINT `MovieCollections_ibfk_1` FOREIGN KEY (`Movie_ID`) REFERENCES `Movies` (`ID`),
  CONSTRAINT `MovieCollections_ibfk_2` FOREIGN KEY (`Collection_ID`) REFERENCES `Collections` (`ID`)
)
